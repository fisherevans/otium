...
// ReaderPrefs tunes the in-app reader typography (#61). Sizes are px, line height
// is unitless, measure is the max line length in ch (0 stays "full width").
...
// CardPrefs tunes the swipe card (#81). The three size fields are px; hero_show
// hides the media block; hero_color switches the hero between color and the
// default grayscale/dither treatment.
...
func DefaultPreferences() Preferences {
	return Preferences{
		Reader: ReaderPrefs{FontSize: 17, LineHeight: 1.62, Measure: 66, Images: true},
		Card: CardPrefs{
